...
class ObjectBytPronajemClass:
    ...
    def __init__(self,id_load,title,obj_number,date_open,status,cena,celkova_cena,poznamka_k_cene,puvodni_cena,description,link,region,subregion,
    ...
    def dbinsertbyty(self):
        try:
            if self.connection.is_connected():
                ...
                query = "INSERT INTO dbrealtor.byty_pronajem(id_load,title,obj_number,date_open,status,cena,celkova_cena,poznamka_k_cene,puvodni_cena,description,link,region,subregion," \
                        "aktualizace,id_ext,stavba,stav_objektu,vlastnictvi,umisteni_objektu,podlazi,uzitna_plocha,terasa,sklep,voda,topeni,plyn,odpad,telekomunikace," \
