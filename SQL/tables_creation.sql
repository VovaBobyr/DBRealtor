CREATE TABLE `byty` (
  ...
  `id_ext` int(11) DEFAULT NULL COMMENT 'ID from external system',
  `actualizace` varchar(45) DEFAULT NULL,
  `stavba` varchar(45) DEFAULT NULL COMMENT 'state of object',
  `stav_objectul` varchar(45) DEFAULT NULL,
  `valsnictvi` varchar(45) DEFAULT NULL,
  ...
  `elaktrina` varchar(20) DEFAULT NULL,
  ...
  `bytycol` varchar(45) DEFAULT NULL,
